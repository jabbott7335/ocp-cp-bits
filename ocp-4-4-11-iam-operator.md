...
Next, edit the clusterrole associated with your `ibm-iam-operand-restricted` ClusterRoleBinding subject:
...
- apiGroups:
  ...
  - watch
```
Next, edit the clusterrole associated with your `ibm-iam-operator` ClusterRoleBinding subject:
